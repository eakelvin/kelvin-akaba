...
const experiences = [
    ...
    },
    {
        ...
        company: 'WebSideMan LLC',
        link: 'https://www.websideman.com/',
        description:
            'Contributed to multiple Next.js projects, including CMS-integrated websites and eCommerce applications. Ensured efficient content workflows with Sanity CMS, backend solutions with MongoDB, Express, Node.js, and deployments on Vercel, delivering high-impact web applications.',
